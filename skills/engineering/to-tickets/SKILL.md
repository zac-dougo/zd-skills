...
The issue tracker and label vocabulary should have been provided to you. If the tracker is not configured for this repo, ask the user where to publish the tickets.
