...
5. **Verify citations by spot-checking.** You can read the codebase and call integrations to verify citations. Do not write files, commit, or modify external state. If you're uncertain a cited item exists or says what's claimed, check it. Don't propagate errors.
